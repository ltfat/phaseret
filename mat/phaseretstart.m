...
%   where basepath is the directory where phaseretstart resides in and it
%   also checks whether LTFAT is installed and whether MEX files were 
%   compiled.
%


requiredLTFAT = '2.1.1';
pgausspath = which('pgauss');
...
fprintf('PHASERET %s. Copyright 2016 Zdenek Prusa.\n',phaseretver);
