...
for pcId = 1:2
    ...
    [chat]=lertisila(s,g,a,M,phaseconv);
    ...
    fprintf('LERTISILA %s W=%d E=%.2f %s\n',phaseconv,1,E,fail);
    
    [chat]=lertisila(s,g,a,M,phaseconv,'maxit',20);
    ...
    [chat]=lertisila(s,g,a,M,phaseconv,'maxit',10,'lookahead',2);
    ...
    fprintf('LERTISILA lookahead=2 %s W=%d E=%.2f %s\n',phaseconv,1,E,fail);
