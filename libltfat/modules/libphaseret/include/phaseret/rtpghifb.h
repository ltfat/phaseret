...
#ifndef _phaseret_rtpghifb_h
#define _phaseret_rtpghifb_h
/** \addtogroup rtpghifb
 *  @{
 */
 ...
 *
 */
typedef struct PHASERET_NAME(rtpghifb_state) PHASERET_NAME(rtpghifb_state);
typedef struct PHASERET_NAME(rtpghifbupdate_plan) PHASERET_NAME(rtpghifbupdate_plan);
 ...
 * #### Versions #
 * <tt>
 * phaseret_rtpghifb_init_d(double gamma, ltfat_int W, ltfat_int a, ltfat_int M,
 *                        double tol, int do_causal, phaseret_rtpghi_state_d** p);
 *
 * phaseret_rtpghifb_init_s(double gamma, ltfat_int W, ltfat_int a, ltfat_int M,
 ...
 * #### Versions #
 * <tt>
 * phaseret_rtpghifb_reset_d(phaseret_rtpghi_state_d* p);
 *
 * phaseret_rtpghifb_reset_s(phaseret_rtpghi_state_s* p);
 * </tt>
 * \returns
 *
 */
PHASERET_API int
PHASERET_NAME(rtpghifb_reset)(PHASERET_NAME(rtpghifb_state)* p, const LTFAT_REAL** sinit );
 ...
 * #### Versions #
 * <tt>
 * phaseret_rtpghifb_set_causal_d(phaseret_rtpghi_state_d* p, int do_causal);
 *
 * phaseret_rtpghifb_set_causal_s(phaseret_rtpghi_state_s* p, int do_causal);
 * </tt>
 * \returns Status code
 */
PHASERET_API int
 ...
 * #### Versions #
 * <tt>
 * phaseret_rtpghifb_set_tol_d(phaseret_rtpghi_state_d* p, double tol);
 *
 * phaseret_rtpghifb_set_tol_s(phaseret_rtpghi_state_s* p, double tol);
 * </tt>
 * \returns Status code
 */
PHASERET_API int
 ...
 * #### Versions #
 * <tt>
 * phaseret_rtpghifb_execute_d(phaseret_rtpghi_state_d* p, const double s[],
 *                           ltfat_complex_d c[]);
 *
 ...
 * #### Versions #
 * <tt>
 * phaseret_rtpghifb_done_d(phaseret_rtpghi_state_d** p);
 *
 * phaseret_rtpghifb_done_s(phaseret_rtpghi_state_s** p);
 * </tt>
 */
PHASERET_API int
 ...
 * #### Versions #
 * <tt>
 * phaseret_rtpghifboffline_d(const double s[], double gamma,
 *                          ltfat_int L, ltfat_int W, ltfat_int a, ltfat_int M,
 *                          double tol, int do_causal, ltfat_complex_d c[]);
 *
 * phaseret_rtpghifboffline_s(const float s[], double gamma,
 *                          ltfat_int L, ltfat_int W, ltfat_int a, ltfat_int M,
 ...
 */
PHASERET_API int
PHASERET_NAME(rtpghifboffline)(const LTFAT_REAL s[], double fc[],
                             ltfat_int L, ltfat_int W, ltfat_int a, ltfat_int M,
                             double gamma, double tol, int do_causal,
                             LTFAT_COMPLEX c[]);
 ...
 */
void
PHASERET_NAME(rtpghifbfgrad)(const LTFAT_REAL logs[], ltfat_int a, ltfat_int M, double gamma,
 ...
 */
void
PHASERET_NAME(rtpghifbtgrad)(const LTFAT_REAL logs[], ltfat_int a, ltfat_int M, double gamma,
                           LTFAT_REAL tgrad[]);
